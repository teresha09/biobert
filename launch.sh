...
python3 main_post.py -data_bio ${cadecarr[$i]} -result_folder ${outputdir} -data ${SCRIPTPATH}/data/cadec_folds/0${i} -entity adr
python3 main_post.py -data ${psytararr[$i]} -result_folder ${outputdir1} -data ${SCRIPTPATH}/data/psytar_folds/0${i}/test.json -entity adr
done
